...
class Core_Arr extends ArrayIterator
{
    ...
    */
     ...
     * @return string
     */
    public static function to_xml(array $array, $tab = "\t", $crlf = CRLF, $attribute_key = '@attributes', $xml_header_string = null)
    {
        ...
        return $xml_header_string . Arr::_format_to_xml_string($array, $attribute_key, $crlf, $tab, '');
    }
    
    protected static function _format_to_xml_string($array, $attribute_key, $crlf, $tab, $left_str = '')
    {
        $str = '';
            ...
            foreach($array as $key => $value)
            {
                ...
                if (is_array($value))
                {
                    if (!is_numeric($key))
                    {
                        ...
                        if (isset($value['@data']))
                        {
                            Arr::_format_attribute_value($value['@data']);
                            $str .= "{$value['@data']}";
                        }
                        ...
                        {
                            $tmp_str = Arr::_format_to_xml_string($value, $attribute_key, $crlf, $tab, $left_str . $tab);
                            if (''!==$tmp_str)
                            {
                    ...
                    {
                        $str .= Arr::_format_to_xml_string($value, $attribute_key, $crlf, $tab, $left_str);
                    }
                }
                else
                {
                    Arr::_format_attribute_value($value);
