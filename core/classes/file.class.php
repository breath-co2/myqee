...
class Core_File
{
     ...
     * @param integer  $piece_size in MB, for each piece to be
     * @param string $storage 物理存储组，不传则为默认
     ...
     *
     * @param string $filename  output filename, if different then an the filename
     * @param string $storage 物理存储组，不传则为默认
     ...
     *
     * @param   string  $extension extension: php, pdf, txt, etc
     * @return  string  mime type on success
     * @return  FALSE   on failure
     */
