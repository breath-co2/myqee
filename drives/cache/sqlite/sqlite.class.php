 ...
 */
class Drive_Cache_Drive_SQLite extends Cache_Drive_Database
{
    /**
     * 默认缓存时间
     *
    ...
    public function __construct($config_name = 'default')
    {
        ...
        (
            'db'         => ':memory:',
            'table'      => 'sharedmemory',
            'expire'     => Cache_Drive_SQLite::DEFAULT_CACHE_TIME,
            'persistent' => false,
            'length'     => 0,
        );
        ...
        if ( Cache_Drive_SQLite::DATA_COMPRESS && function_exists('gzcompress') )
        {
            $this->_compress = true;
        }
