...
define('CKFINDER_CONNECTOR_DEFAULT_USER_FILES_PATH',UPLOADPATH);
define('CKFINDER_CONNECTOR_LANG_PATH',str_replace("\\",'/',dirname(__FILE__))."/lang");
define('CKFINDER_CONNECTOR_CONFIG_FILE_PATH',str_replace("\\",'/',realpath(dirname(__FILE__).'/../'))."/config.php");
...
if (CKFINDER_CONNECTOR_PHP_MODE == 4) {
    define('CKFINDER_CONNECTOR_LIB_DIR', str_replace("\\",'/',dirname(__FILE__))."/php4");
} else {
    define('CKFINDER_CONNECTOR_LIB_DIR', str_replace("\\",'/',dirname(__FILE__))."/php5");
}
