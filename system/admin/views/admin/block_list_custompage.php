...
<tr<?php if($i%2==0){echo ' class="td3"';} ?> onmouseover="tr_moveover(this)" onmouseout="tr_moveout(this)">
	...
	<a title="点击访问" href="http://<?php echo Myqee::config('core.mysite_domain').'/'.ltrim($file,'/');?>" target="_blank"><img src="<?php echo ADMIN_IMGPATH;?>/admin/external.png" /></a>
	</td>
	<td class="td2">&nbsp;<?php echo $file;?></td>
	<td class="td2" align="center" style="padding:3px;">
	<input class="btnl" onclick="goUrl('<?php echo Myqee::url('block/view_edit/custompage/'.$item['id']);?>','_blank')"' type="button" value="自定义页碎片" />
	</td>
</tr>
<?php
