...
?>
<div class="loaction">
您的位置：<a href="<?php echo Myqee::url('index');?>">管理首页</a> -&gt; <a href="<?php echo Myqee::url('model/index');?>">模型管理</a> -&gt; 导入模型
</div>
...
<form method="post" name="myforms" action="<?php echo Myqee::url('model/input/');?>" target="hiddenFrame" enctype="multipart/form-data">
<div id="mytagmain_1">
...
<table border="0" cellpadding="4" cellspacing="1" align="center" class="tableborder" style="border-bottom:none;">
	...
	<tr>
		<td class="td1" align="right" width="150">上传模型文件：</td>
...
<table border="0" cellpadding="4" cellspacing="1" align="center" class="tableborder" style="border-top:none;">
	<tr>
		<td class="td1" align="right" width="150">模型导入密码：</td>
	...
	<tr>
		...
		<td class="td1"><input type="submit" class="bbtn" value="导入模型" /> <input onclick="goback(-1,'<?php echo Myqee::url('model/index'); ?>')" type="button" value="返回" class="btns" /></td>
	</tr>
</table>
