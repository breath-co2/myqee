...
?>
<div class="loaction">
您的位置：<a href="<?php echo Myqee::url('index');?>">管理首页</a> -&gt; <a href="<?php echo Myqee::url('task/index');?>">任务管理</a> -&gt; 导入计划任务
</div>
...
<form method="post" name="myforms" action="<?php echo Myqee::url('task/input/');?>" target="hiddenFrame" enctype="multipart/form-data">
<div id="mytagmain_1">
...
<table border="0" cellpadding="4" cellspacing="1" align="center" class="tableborder" style="border-top:none;">
	<tr>
		...
		<td class="td2"><input type="text" name="key" size="20" class="input" value="" />  &nbsp;<font color="#a3a3a3">若任务无加密密码，则留空即可</font></td>
	</tr>
	<tr>
		<td class="td1" align="right">&nbsp;</td>
		<td class="td1"><input type="submit" class="bbtn" value="导入任务" /> <input onclick="goback(-1,'<?php echo Myqee::url('task/index') ?>')" type="button" value="返回" class="btns" /></td>
	</tr>
</table>
