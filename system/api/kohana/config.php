 ...
 */
$config['index_page'] = Myqee::config('core.myqee_page');

/**
 * Fake file extension that will be added to all generated URLs. Example: .html
 */
$config['url_suffix'] = Myqee::config('core.url_suffix');
 ...
 */
$config['internal_cache_path'] = CACHEPATH;
 ...
 */
$config['extension_prefix'] = Myqee::config('core.extension_prefix');
...
if (ADMINPATH!=false){
	if (defined('MY_MODULE_PATH')){
		$config['modules'][] = MYAPPPATH .'admin'.MY_MODULE_PATH.'/';
	}
}else{
