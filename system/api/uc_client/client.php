...
/*
	...
	$Id: client.php,v 1.1 2009/06/18 05:21:16 jonwang Exp $
*/
...
function uc_api_input($data) {
	$s = urlencode(uc_authcode($data.'&agent='.md5($_SERVER['HTTP_USER_AGENT'])."&time=".$_SERVER['REQUEST_TIME'], 'ENCODE', UC_KEY));
	return $s;
}
