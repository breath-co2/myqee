 ...
 * Array helper class.
 *
 * $Id: pinyin.php,v 1.1 2009/08/27 10:09:02 jonwang Exp $
 *
 * @package    Core
 * @author     Myqee Team
...
class pinyin_Core {
	...
	static protected function _g($num){
		...
		for($i=count(self::$d)-1;$i>=0;$i--){if(self::$d[$i][1]<=$num)break;}
			return self::$d[$i][0];
		}
	}
	
	static public function render($str,$charset = null){
		if($charset && ($charset=strtoupper($charset))!='GBK' ){
