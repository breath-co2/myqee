...
Editor.Parser = (function() {
  ...
  var parseXML = function(source) {
    ...
    var harmlessTokens = {"text": true, "entity": true, "comment": true, "cdata": true, "code": true};
    function element(style, content) {
      if (content == "<") cont(tagname, attributes, endtag(tokenNr == 1));
      else if (content == "{") cont(codename, attributes, endtag(tokenNr == 1));
	...
	function codename(style, content) {
      if(style == "name"){
        currentTag = content.toLowerCase();
        mark("codename");
        cont();
    ...
    function closetagname(style, content) {
      ...
      else if (style == "code" && context && content.toLowerCase() == context.name) {
        popContext();
        mark("codename");
      }
     else {
    ...
    function attribute(style, content) {
      ...
      else if (content == ">" || content == "}" || content == "/>") pass(endtag);
      else pass();
    }
