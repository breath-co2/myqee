...
(function() {
	...
	(function(autorun) {
		...
		div.innerHTML = [
		/*遮罩*/
		"<div id='maskLevel' style=\'" + maskStyle + ';z-index:10000;\'></div>', IE6 ? ("<iframe id='maskIframe' style='" + maskStyle + ";z-index:9999;filter:alpha(opacity=0);opacity:0' frameborder='0'></iframe>") : '',
		/*窗体*/
		"<div id='ym-window' style='overflow:auto;position:absolute;text-align:left;z-index:10001;display:none;",IE6 && dftCfg.fixPosition ? 'top:expression((eval(document.compatMode &&document.compatMode=="CSS1Compat") ?documentElement.scrollTop:document.body.scrollTop)+ym_wintop);':'' , "'>", IE6 ? "<iframe style='width:100%;height:100%;position:absolute;top:0;left:0;z-index:-1;' frameborder='0'></iframe>": '', "<div class='ym-tl' id='ym-tl'><div class='ym-tr'><div class='ym-tc' style='cursor:move;'><div class='ym-header-text'></div><div class='ym-header-tools'>", "<div class='ymPrompt_min' title='最小化'><strong>"+(isIE?'0':'＿')+"</strong></div>", "<div class='ymPrompt_max' title='最大化'><strong>"+(isIE?'1':'□')+"</strong></div>", "<div class='ymPrompt_close' title='关闭'><strong>"+(isIE?'r':'×')+"</strong></div>", "</div></div></div></div>", "<div class='ym-ml' id='ym-ml'><div class='ym-mr'><div class='ym-mc'><div class='ym-body' style='position:relative'></div></div></div></div>", "<div class='ym-ml' id='ym-btnl'><div class='ym-mr'><div class='ym-btn'></div></div></div>", "<div class='ym-bl' id='ym-bl'><div class='ym-br'><div class='ym-bc'></div></div></div>", "</div>",
		/*阴影*/
